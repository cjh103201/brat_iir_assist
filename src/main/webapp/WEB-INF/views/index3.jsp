        ...
        <nav class="navbar navbar-default ">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="home.action"><img src="resources/assets/img/logo.png" alt=""></a>
                </div>
        ...
        <div class="slider-area">
            <div class="slider">
                <div id="bg-slider" class="owl-carousel owl-theme">
                    ...
                    <div class="item"><img src="resources/assets/img/slide1/slider-image-1.jpg" alt="GTA V"></div>
